...
Gem::Specification.new do |gem|
  ...
  gem.add_development_dependency 'test-unit', '~> 3.0', '>= 3.0.2'
  
  
  gem.add_runtime_dependency "fluentd", "~> 0.12.0"
  gem.add_runtime_dependency 'fluent-mixin-plaintextformatter', '~> 0.2', '>= 0.2.1'
  gem.add_runtime_dependency 'fluent-mixin-config-placeholders', '~> 0.3', '>= 0.3.0'
